...
class Product(models.Model):
    ...
    created_by = models.ForeignKey(
        User, on_delete=CASCADE, related_name="ProductsCreate")
    category = models.ForeignKey(
        Category, on_delete=CASCADE, related_name="ProductsCategories")
...
class Order(models.Model):
    ...
    user_id = models.ForeignKey(
        User, on_delete=CASCADE, related_name="CustomerOrders")
    address = models.CharField(max_length=1000)
...
class OrderDetails(models.Model):
    order_id = models.ForeignKey(
        Order, on_delete=CASCADE, related_name="order_made")
    product_id = models.ForeignKey(
        Product, on_delete=CASCADE, related_name="product_bought")
